package com.ajfqo.spring.ex.mybatis.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.ajfqo.spring.ex.mybatis.domain.Review;
import com.ajfqo.spring.ex.mybatis.repository.ReviewRepository;
...
public class ReviewService {
	...
	public int addReviewByObject(Review review) {
		int count = reviewRepository.insertReviewByOject(review);
		return count;
	}
